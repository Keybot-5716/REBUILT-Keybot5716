...
public record FiducialAprilTagObservation(
    int id, double txnc, double tync, double ambiguity, double area) implements StructSerializable {
  ...
  public static FiducialAprilTagObservation[] fromLimelight(
